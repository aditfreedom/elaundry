                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6">
                                                    <h5>Anda Akan Melakukan Orderan, Silahkan Input Berat Estimasi Cucian.</h5>
                                                    ...
                                                    <div class="form-group mb-2" hidden>
                                                      ...
                                                      data-allow-clear="true">
                                                          @foreach ($paket as $data)
                                                          <option selected value="{{$data->id}}">{{$data->nama_paket}}</option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                                  @foreach ($paket as $data)
                                                  <div class="form-group mb-2" hidden>
                                                            ...
                                                            <input type="number" id="harga" name="harga" value="{{$data->harga}}" class="form-control" placeholder="Harga Paket"  maxlength="200">
                                                        </div>
                                                        @endforeach
                                                        <div class="form-group mb-2">
                                                            <label class="font-weight-bold">Estimasi Berat Cucian (Kg)</label>
                                                            <input type="number" id="berat" name="berat" class="form-control" placeholder="Berat Cucian"  maxlength="200" required>
                                                        </div>
                                                        <div class="form-group mb-2" hidden>
                                                            <label class="font-weight-bold">Total Biaya</label>
                                                            <input type="text" id="total" name="total" class="form-control" placeholder="Total Biaya" maxlength="200" value="0">
                                                        </div>
                                                        <div class="form-group mb-2" hidden>
