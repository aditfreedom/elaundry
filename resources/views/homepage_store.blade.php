                                            ...
                                            <div class="rounded position-relative fruite-item">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex flex-lg-wrap justify-content-center">
                                                        <a href="{{url('store/product?str='.$data->id)}}" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Lihat Paket</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
